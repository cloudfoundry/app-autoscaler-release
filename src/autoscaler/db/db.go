...
type DatabaseConfig struct {
	...
	MaxOpenConnections    int32         `yaml:"max_open_connections" json:"max_open_connections,omitempty`       // Missing a closing double quote character in the value
	MaxIdleConnections    int32         `yaml:"max_idle_connections" json:"max_idle_connections,omitempty`       // Missing a closing double quote character in the value
	ConnectionMaxLifetime time.Duration `yaml:"connection_max_lifetime" json:"connection_max_lifetime,omitempty` // Missing a closing double quote character in the value
