	...
	Describe("Get scaling histories", func() {
		...
		Context("Cloud Controller api is not available", func() {
			...
			It("should error with status code 500", func() {
				checkPublicAPIResponseContentWithParameters(getScalingHistories, apiURL, pathVariables, parameters, http.StatusInternalServerError, map[string]interface{}{
		...
		Context("UAA api returns 401", func() {
			...
			It("should error with status code 401", func() {
				checkPublicAPIResponseContentWithParameters(getScalingHistories, apiURL,
		...
		Context("Get scaling histories", func() {
			...
			It("should get the scaling histories ", func() {
				...
				checkScalingHistoryResult(apiURL, pathVariables, parameters, result)
