...
func main() {
	...
	appManager := aggregator.NewAppManager(logger, egClock, conf.Aggregator.PolicyPollerInterval, conf.Pool.NodeCount, conf.Pool.NodeIndex, conf.Aggregator.MetricCacheSizePerApp, policyDb, appMetricDB)
