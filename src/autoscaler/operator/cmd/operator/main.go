...
func main() {
	...
	scalingEngineHttpclient, err := helpers.CreateHTTPClient(&conf.ScalingEngine.TLSClientCerts, logger, "scalingEngine")
	if err != nil {
	...
	schedulerHttpclient, err := helpers.CreateHTTPClient(&conf.Scheduler.TLSClientCerts, logger, "scheduler")
	if err != nil {
